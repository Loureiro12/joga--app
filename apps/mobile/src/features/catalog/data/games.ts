...
export const GAMES: GameDefinition[] = [
  ...
  },
  {
    ...
    color: colors.primary,
    illustration: 'trophy',
    // Piso técnico: um casal já joga. A graça é a disputa, e ela começa em dois casais.
    minPlayers: 2,
    recommendedPlayers: 6,
    maxPlayers: 12,
    playersLabel: '2 a 6 casais',
    durationLabel: '25–35 min',
    durationShort: '30 min',
    infoChips: [
      { emoji: '📱', label: 'Um celular por pessoa' },
      { emoji: '💞', label: 'Melhor com 3 casais' },
      { emoji: '🔒', label: 'Respostas secretas' },
    ],
    howToPlay: [
      'Formem as duplas: quem convida escolhe, e a dupla só fecha quando a outra pessoa aceita.',
      'Cada pergunta vai para os dois celulares. Respondam separados — não vale mostrar nem sinalizar.',
      'Quando todos responderem, as respostas abrem juntas. Deu match, o casal pontua.',
    ],
    // As categorias do banco de perguntas. A picante é a última, e só entra se o host marcar.
    wordCategories: [
      { id: 'Dia a dia', label: 'Dia a dia', emoji: '😂' },
      { id: 'Relacionamento', label: 'Relacionamento', emoji: '❤️' },
      { id: 'Quem conhece melhor', label: 'Quem conhece melhor', emoji: '👀' },
      { id: 'Nossa história', label: 'Nossa história', emoji: '🕰' },
    ...
    // "Sem limite" é o 0: a partida vai até o host encerrar.
    roundOptions: [10, 20, 30, 0],
    defaults: { players: 6, category: '', rounds: 20 },
    tags: ['Casais', 'Festa'],
    playable: true,
  },
];
